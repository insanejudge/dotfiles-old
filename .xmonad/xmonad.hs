...
myStartHook = spawnOnce "/bin/zsh -c \"source /home/daniel/.xmonad/dzen4xmonad\"" <+>
...
myKeyBindings conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
    -- <basic commands>
    [ ((modMask .|. shiftMask,     xK_q         ), unsafeSpawn "pkill -9 -f '/bin/zsh -c source /home/daniel/.xmonad/dzen4xmonad'" >> io (exitWith ExitSuccess))
